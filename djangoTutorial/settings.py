...
SECRET_KEY = 'django-insecure-t#t=8ak#4%=t^dr_xx5=@q1$nm#+s1_6$q(zgr(@c)zgvju*kf'
...
MEDIA_ROOT = os.path.join(BASE_DIR, 'media') # directory (not in the db)
